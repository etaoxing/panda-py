...
./bin/build.sh 0.17.0
cd archive/panda_py_1.0.0_libfranka_0.17.0/
pip install panda_python-*libfranka.0.17.0-cp310*.whl
```
to install the binary wheel for libfranka 0.17.0 and Python 3.10.
